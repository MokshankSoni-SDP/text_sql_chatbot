                ...
                messages=[
                    {
                        ...
                        "content": (
                            ...
                            "5. DATA REASONING (IMPORTANT): Use domain and common-sense logic to infer implicit filters and ranking signals from natural language, even when not explicitly mentioned by the user:\n"
                            "   - 'Kids / Children / Toddler': Prefer smaller sizes or 'Kids' categories. Avoid adult footwear.\n"
                            "   - 'Men / Women': Filter by gender column if available.\n"
                            "   - 'Summer / Beach': Prefer Sandals, Slippers, Open footwear. De-prioritize Boots.\n"
                            "   - 'Winter / Cold': Prefer Boots, Closed footwear. De-prioritize open footwear.\n"
                            "   - 'Comfortable / Walking': Apply preference for cushioned, soft, breathable footwear.\n"
                            "   - 'Running / Gym': Prefer Sports/Running categories.\n"
                            "   - 'Cheap / Budget': Sort by Price ASC or filter Price < Avg.\n"
                            "   - 'Best / Top / Popular': Sort by Rating DESC (or Price DESC if rating missing).\n"
                            "   - 'Premium / Luxury': Prefer higher price and ratings.\n"
