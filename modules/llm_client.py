                ...
                messages=[
                    {
                        ...
                        "content": (
                            ...
                            "5. DATA REASONING (IMPORTANT): Use domain logic to infer filters implied by natural language terms:\n"
                            "   - 'Kids/Children' -> Filter for small sizes (if size col exists) or 'Kids' category.\n"
                            "   - 'Summer' -> Filter for Sandals, Slippers, Flip Flops, etc.\n"
                            "   - 'Winter' -> Filter for Boots, Jackets, etc.\n"
                            "   - 'Cheap/Budget' -> Sort by Price ASC or filter Price < Avg.\n"
                            "   - 'Best/Top' -> Sort by Rating DESC or Price DESC (if 'Premium').\n"
